...
static_assert(sshmcp::tool<sshmcp::upload_file_tool_t>);
static_assert(sshmcp::tool<sshmcp::download_file_tool_t>);
...
using tools_t =
    sshmcp::tool_set_t<sshmcp::exec_tool_t, sshmcp::read_file_tool_t,
                       ...
                       sshmcp::forward_close_tool_t, sshmcp::upload_file_tool_t,
                       sshmcp::download_file_tool_t>;

[[maybe_unused]] auto const t1 = t::add_test("list", [] {
    auto const tools = tools_t::list();
    t::expect(tools.size() == 8, "eight tools");
    ...
    t::expect(tools[6]["name"] == "upload_file", "upload 7th");
    t::expect(tools[7]["name"] == "download_file", "download 8th");
